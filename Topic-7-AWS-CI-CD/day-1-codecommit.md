# AWS CI/CD Explained for Beginners | PART 1 | Understanding AWS CodeCommit
...
![Created Repo](img/2.png)

After the repository is created, explore the repository dashboard, including:
...
Upload a file through the AWS Console.

Later, clone the repository using Git, and push files from your local machine.
...
- ✅ Understand what CI/CD is and why it is important.
- ✅ Learn the common CI/CD tools used in the industry.
- ✅ Explore the AWS Developer Tools ecosystem.
- ✅ Understand the role of AWS CodeCommit in a CI/CD pipeline.
- ✅ Learn the advantages and limitations of AWS CodeCommit.
- ✅ Create your first CodeCommit repository.
- ✅ Prepare for building complete CI/CD pipelines using AWS services.

---

## What's Next?

In the next article, we will learn about **AWS CodePipeline** and understand how it automates the complete software delivery lifecycle by connecting source code, build, testing and deployment into a single CI/CD workflow.

We will also see how CodePipeline integrates with services like **GitHub**, **AWS CodeBuild**, and **AWS CodeDeploy** to automate deployments from source code to production.